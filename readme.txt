...
Une fois ceci fait, il vous faudrat initialiser votre base de données. Pour cela, il vous faudra créer une base nommée 'hibernate' et posséder un utilisateur nommé 'root' et dont le mot de passe est 'root' (ou modifier les champs user et password dans le fichier hibernate.cfg.xml), puis executer les scripts .sql : d'abord stock.sql puis dailyrecord.sql
